...
public class TeleOps extends OpMode {
    ...
    public void loop() {
        ...
        double up = (gamepad1.right_trigger-gamepad1.left_trigger)+0.05;
        ...
        else if (gamepad1.right_bumper&&arm<armMax){
            arm+=armChange;
            leftArm.setTargetPosition(arm);
            rightArm.setTargetPosition(arm);
            leftArm.setVelocity(2000);
        ...
        if (gamepad1.x&&(System.currentTimeMillis()-startTime2)>=300){
